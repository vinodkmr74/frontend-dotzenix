  ...
  return (
      <>
          <Service_hero
            ...
            text={
              "We build modern, responsive, and high-performing Shopify stores with custom design, secure functionality, and seamless shopping experiences to help businesses grow online sales and customer engagement."
            }
            image={"image/shopifi2.png"}
            btn={"Get start"}
          />
    
          <Service_abouts
            heading={"What is Shopify App Development?"}
            text={
              "Shopify Development is the process of designing, developing, and customizing eCommerce websites using the Shopify platform to create secure, responsive, and user-friendly online stores. It helps businesses manage products, payments, orders, and customer experiences efficiently while growing their online presence and sales."
            }
          ...
          <div className="why-chose">
            <div className="why-chose-heading">
              <h1>Why Choose Our Shopify Development Services?</h1>
            </div>
            {serviceData.whyshopifyService.map((item, index) => (
          ...
          <div className="our_frontend_service">
            <div className="our_fron_service_in">
              <div className="our_frontend_service_text">
                <h1>Our Shopify Developmen Services</h1>
              </div>
    
              <div className="our_frontend_service_card_main">
                {serviceData.shopifyservicecard.map((item, index) => (
          ...
          <div className="why-chose">
            ...
            {serviceData.shopifyusetech.map((item, index) => (
              <div className="why-chose-in" key={index}>
                <div className="why-heding">
                  <ImArrowRight2 className="arro-icon" />
                  <p>
