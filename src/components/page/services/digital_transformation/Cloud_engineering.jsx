  ...
  return (
    <>
      <Service_hero
        ...
        text={
          "We provide secure, scalable, and high-performance cloud engineering solutions to improve infrastructure management, application deployment, and business scalability."
        }
      ...
      <Service_abouts
        heading={"What is Cloud Engineering?"}
        text={
          "Cloud Engineering is the process of designing, managing, and optimizing cloud infrastructure and services to improve scalability, security, performance, and business operations through cloud platforms."
        }
      ...
      <div className="why-chose">
        <div className="why-chose-heading">
          <h1>Why Choose Our Cloud Engineering?</h1>
        </div>
        {serviceData.whyChooseCloudEngineering.map((item, index) => (
      ...
      <div className="our_frontend_service">
        <div className="our_fron_service_in">
          <div className="our_frontend_service_text">
            <h1>Our Cloud Engineering Services</h1>
          </div>
      ...
      <div className="why-chose">
        <div className="why-chose-heading">
          <h1>Technologies We Use in Cloud Engineering </h1>
        </div>
